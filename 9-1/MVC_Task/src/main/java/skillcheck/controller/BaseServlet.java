...
public abstract class BaseServlet extends HttpServlet {
	...
	protected static final String CONST_ELEMENT_NAME_REQUEST = /*ここへ記述*/"requestType";
...
@throws IOException
	...
	protected boolean validateLogin(final HttpServletRequest request) throws IOException {
		...
		try {
			...
			// ↓ここへ記述
			EmployeeBean emp = new EmployeeBean(reqEmpId);
			
			ems = new EmployeeManagementService();
			responseBean = ems.getEmployeeData(ExecuteCase.FIND_BY_EMPID,emp);
